...
<div class="container">
    ...
    {#if results === '1'}
      ...
      <p class="results-info">You learn about the world by exploring and by breaking all the software you've written</p>
    {/if}
    {#if results === '2'}
      <p class="results">You are a panicking type</p>
      <img class="cat-img" src={ChristmasCat2} alt="cat">
      <p class="results-info">You explore a lot, but you generally don't know what to do when something unexpected happens (or when you get overwhelped by bugs)</p>
    {/if}
    {#if results === '3'}
      <p class="results">You are a conservative type</p>
      <img class="cat-img" src={ChristmasCat3} alt="cat">
      <p class="results-info">You enjoy sticking to what's generally accepted, be it food, beliefs, or widely-adopted web technologies</p>
    {/if}
    {#if results === '4'}
      <p class="results">You are an indifferent type</p>
      <img class="cat-img" src={ChristmasCat4} alt="cat">
      <p class="results-info">More often than not you don't care about the things happening all around you and would rather dust off your C system programming skills</p>
    {/if}
